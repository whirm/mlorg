(* OASIS_START *)
(* DO NOT EDIT (digest: efdec55f09705649c9aea3e54d08ce1b) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [
          ("common/mlorg-common", ["common"]);
          ("syntax/inline/mlorg-syntax-inline", ["syntax/inline"]);
          ("syntax/blocks/mlorg-syntax-blocks", ["syntax/blocks"]);
          ("document/mlorg-document", ["document"]);
          ("exports/mlorg-exports", ["exports"]);
          ("mlorg", [])
       ];
     lib_c = [];
     flags = [];
