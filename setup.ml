...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6dc6c1648c3f6161860159a1900a42e8) *)
(*
            ...
            [
               ...
               Library
                 ({
                     ...
                     },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "syntax/inline";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           FindlibPackage ("batteries", None);
                           FindlibPackage ("dynlink", None);
                           InternalLibrary "mlorg-common"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "syntax/blocks";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           FindlibPackage ("batteries", None);
                           FindlibPackage ("dynlink", None);
                           InternalLibrary "mlorg-syntax-inline"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("batteries", None);
                           FindlibPackage ("dynlink", None);
                           InternalLibrary "mlorg-syntax-blocks"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["Document"; "Filter"; "Modules"];
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                      lib_findlib_containers = [];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("batteries", None);
                           FindlibPackage ("dynlink", None);
                           InternalLibrary "mlorg-document"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["Xml"; "Html"; "Latex"; "Quote"];
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                      lib_findlib_containers = [];
